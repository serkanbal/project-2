...
public class DetailFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        TextView mDetailCompany = (TextView) view.findViewById(R.id.detail_company);
        TextView mDetailPlatform = (TextView) view.findViewById(R.id.detail_platform);
        TextView mDetailPrice = (TextView) view.findViewById(R.id.detail_price);
        ImageView mDetailRating = (ImageView) view.findViewById(R.id.detail_ratingImages);
